...
class ExampleStartupBenchmark {
    ...
    fun startup() = benchmarkRule.measureRepeated(
        packageName = "com.google.lazysyncronizedscroll",
        metrics = listOf(FrameTimingMetric(),MemoryUsageMetric(mode = MemoryUsageMetric.Mode.Max)),
        iterations = 5,
...
//        }
        ...
        device.waitForIdle()
//        device.swipe(500, 500, 1500, 500, 10)
//        device.waitForIdle()
    }
...
//        horizontalScroll(CompilationMode.Full())
    ...
    @OptIn(ExperimentalMetricApi::class)
    private fun horizontalScroll(compilationMode: CompilationMode) {
        var firstStart = true
        benchmarkRule.measureRepeated(
            packageName = "com.google.lazysyncronizedscroll",
            metrics = listOf(
